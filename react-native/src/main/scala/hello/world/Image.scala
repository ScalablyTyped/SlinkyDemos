...
import slinky.native.{BoundingBox, ImageErrorEvent, ImageProgressEvent, ImageURISource, LayoutChangeEvent, NativeSyntheticEvent}
...
@react object Image extends ExternalComponent {
  case class Props(
      ...
      source: js.UndefOr[ImageURISource | js.Object | Seq[ImageURISource | js.Object]] = js.undefined,      loadingIndicatorSource: js.UndefOr[Seq[ImageURISource | Int]] = js.undefined,
